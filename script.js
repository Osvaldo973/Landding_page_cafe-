...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let coffeeProducts = []; // Se cargará dinámicamente desde Firestore
    ...
    /* =============================================
       PRODUCTOS — Catálogo de café (Carga de Firebase)
    ============================================= */
    async function loadAndRenderProducts() {
        ...
        grid.innerHTML = `
            <div style="grid-column: 1/-1; text-align: center; padding: 40px; color: var(--text-muted);">
                <i class="fa-solid fa-circle-notch fa-spin" style="font-size: 2.5rem; margin-bottom: 15px; color: var(--coffee-gold);"></i>
                <p>Cargando granos de café premium...</p>
            </div>
        `;
        ...
        try {
            ...
            // Sembrar productos iniciales si está vacío
            if (products.length === 0) {
                console.log("Inicializando base de datos con productos por defecto...");
            ...
            grid.innerHTML = `
                <div style="grid-column: 1/-1; text-align: center; padding: 40px; color: var(--coffee-main);">
                    ...
                    <small>Por favor, asegúrate de haber configurado tu archivo de credenciales de Firebase en firebase-config.js</small>
                </div>
            `;
        }
    }
    ...
    function renderProducts(products) {
        ...
        products.forEach(product => {
            ...
            // Si hay imagen real, la renderizamos. Si no, mostramos el placeholder de ícono.
            const imageContainerContent = product.imageUrl 
                ? `<div class="product-img-real-container" style="background-image: url('${product.imageUrl}')"></div>`
                : `<div class="placeholder-img" style="background: linear-gradient(135deg, ${product.bgColor || '#F2E8D9'}, #e8d5bb);">
                       <i class="fa-solid ${product.icon || 'fa-mug-hot'}" style="font-size: 4rem; color: ${product.iconColor || '#6B3A1F'}; opacity: 0.85;"></i>
                   </div>`;
